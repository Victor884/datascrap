/*
VALIDACAO FIX_VALORES_V1
Rode este arquivo inteiro no SSMS/Azure Data Studio.
Ele gera #PROFESSORES, grava o resultado ajustado em #MEU_SALARIO_COMPOSTO
e ja retorna os diagnosticos comparando contra [GestaoBI].dbo.[AIN_SALARIO_COMPOSTO].

Para trocar o mes, altere apenas @DATA_BASE na linha DECLARE @DATA_BASE.
*/
...
WITH
  ...
  (
    ...
    , SALARIO   = CAST(
        CASE
          WHEN 1 = 0 /* regra ampla de março desativada: usar PS sem SC_FIN gerou falsos positivos */
        AND @DATA_BASE = CONVERT(date, '20260301', 112)
